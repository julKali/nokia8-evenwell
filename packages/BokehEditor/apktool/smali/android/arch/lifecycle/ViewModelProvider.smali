...
.method public get(Ljava/lang/String;Ljava/lang/Class;)Landroid/arch/lifecycle/ViewModel;
    ...
    iget-object v3, p0, Landroid/arch/lifecycle/ViewModelProvider;->mViewModelStore:Landroid/arch/lifecycle/ViewModelStore;

    invoke-virtual {v3, p1}, Landroid/arch/lifecycle/ViewModelStore;->get(Ljava/lang/String;)Landroid/arch/lifecycle/ViewModel;
    ...
    .local v2, "viewModel":Landroid/arch/lifecycle/ViewModel;
    :goto_0
    return-object v2

    .line 128
    .end local v2    # "viewModel":Landroid/arch/lifecycle/ViewModel;
    ...
    .line 133
    :cond_1
    iget-object v3, p0, Landroid/arch/lifecycle/ViewModelProvider;->mFactory:Landroid/arch/lifecycle/ViewModelProvider$Factory;
    ...
    invoke-virtual {v3, p1, v0}, Landroid/arch/lifecycle/ViewModelStore;->put(Ljava/lang/String;Landroid/arch/lifecycle/ViewModel;)V
    ...
    .line 136
    .end local v1    # "viewModel":Landroid/arch/lifecycle/ViewModel;
    .restart local v2    # "viewModel":Landroid/arch/lifecycle/ViewModel;
    goto :goto_0
.end method
