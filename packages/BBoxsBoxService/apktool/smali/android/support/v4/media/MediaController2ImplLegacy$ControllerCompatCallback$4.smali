.class Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback$4;
...
# direct methods
.method constructor <init>(Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;Landroid/support/v4/media/MediaItem2;)V
    .locals 0
    .param p1, "this$1"    # Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;

    .line 1034
    iput-object p1, p0, Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback$4;->this$1:Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;

    iput-object p2, p0, Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback$4;->val$item:Landroid/support/v4/media/MediaItem2;
...
.method public run()V
    ...
    .line 1037
    iget-object v0, p0, Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback$4;->this$1:Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback$4;->this$1:Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback$4;->val$item:Landroid/support/v4/media/MediaItem2;
