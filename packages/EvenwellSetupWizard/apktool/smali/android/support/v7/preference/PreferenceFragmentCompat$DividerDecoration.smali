...
.method private shouldDrawDividerBelow(Landroid/view/View;Landroid/support/v7/widget/RecyclerView;)Z
    ...
    .line 809
    :cond_1
    iget-boolean p0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat$DividerDecoration;->mAllowDividerAfterLastItem:Z
    ...
    .line 813
    invoke-virtual {p2, p0}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;

    move-result-object p0

    .line 814
    instance-of p1, p0, Landroid/support/v7/preference/PreferenceViewHolder;

    if-eqz p1, :cond_2

    check-cast p0, Landroid/support/v7/preference/PreferenceViewHolder;

    .line 815
    invoke-virtual {p0}, Landroid/support/v7/preference/PreferenceViewHolder;->isDividerAllowedAbove()Z
...
.method public getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$State;)V
    ...
    .line 798
    iget p0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat$DividerDecoration;->mDividerHeight:I
...
.method public setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 827
    iget-object p0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat$DividerDecoration;->this$0:Landroid/support/v7/preference/PreferenceFragmentCompat;

    invoke-static {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->access$200(Landroid/support/v7/preference/PreferenceFragmentCompat;)Landroid/support/v7/widget/RecyclerView;

    move-result-object p0

    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView;->invalidateItemDecorations()V
