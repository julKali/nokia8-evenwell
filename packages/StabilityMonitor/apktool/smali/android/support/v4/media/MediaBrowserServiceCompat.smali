...
.method public final getBrowserRootHints()Landroid/os/Bundle;
    ...
    .line 1198
    iget-object p0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->mImpl:Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;

    invoke-interface {p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;->getBrowserRootHints()Landroid/os/Bundle;
...
.method public getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 1179
    iget-object p0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->mSession:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public notifyChildrenChanged(Ljava/lang/String;)V
    ...
    invoke-interface {p0, p1, v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;->notifyChildrenChanged(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public notifyChildrenChanged(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;->notifyChildrenChanged(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;->onBind(Landroid/content/Intent;)Landroid/os/IBinder;
...
.method public onCreate()V
    ...
    invoke-interface {p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;->onCreate()V
...
.method public onCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$Result;)V
    ...
    .line 1152
    invoke-virtual {p3, p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->sendError(Landroid/os/Bundle;)V
...
.method public onLoadItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$Result;)V
    ...
    .line 1100
    invoke-virtual {p2, p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->setFlags(I)V

    const/4 p0, 0x0

    .line 1101
    invoke-virtual {p2, p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->sendResult(Ljava/lang/Object;)V
...
.method public onSearch(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$Result;)V
    ...
    .line 1127
    invoke-virtual {p3, p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->setFlags(I)V

    const/4 p0, 0x0

    .line 1128
    invoke-virtual {p3, p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->sendResult(Ljava/lang/Object;)V
...
.method removeSubscription(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/IBinder;)Z
    ...
    .line 1295
    iget-object p0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;->subscriptions:Ljava/util/HashMap;
...
.method public setSessionToken(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;->setSessionToken(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
