...
.method constructor <init>(C[F)V
    ...
    iput-char p1, p0, Landroid/support/v4/b/b$b;->a:C

    iput-object p2, p0, Landroid/support/v4/b/b$b;->b:[F

    return-void
.end method

.method constructor <init>(Landroid/support/v4/b/b$b;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-char v0, p1, Landroid/support/v4/b/b$b;->a:C

    iput-char v0, p0, Landroid/support/v4/b/b$b;->a:C

    iget-object v0, p1, Landroid/support/v4/b/b$b;->b:[F

    iget-object p1, p1, Landroid/support/v4/b/b$b;->b:[F

    const/4 v1, 0x0

    array-length p1, p1

    invoke-static {v0, v1, p1}, Landroid/support/v4/b/b;->a([FII)[F

    move-result-object p1

    iput-object p1, p0, Landroid/support/v4/b/b$b;->b:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v0 .. v9}, Landroid/support/v4/b/b$b;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v6 .. v24}, Landroid/support/v4/b/b$b;->a(Landroid/graphics/Path;DDDDDDDDD)V
...
.method public static a([Landroid/support/v4/b/b$b;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v0, v1, v3, v4}, Landroid/support/v4/b/b$b;->a(Landroid/graphics/Path;[FCC[F)V

    aget-object v1, p0, v2

    iget-char v1, v1, Landroid/support/v4/b/b$b;->a:C
...
# virtual methods
.method public a(Landroid/support/v4/b/b$b;Landroid/support/v4/b/b$b;F)V
    .locals 4

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p1, Landroid/support/v4/b/b$b;->b:[F

    array-length v1, v1

    if-ge v0, v1, :cond_0

    iget-object v1, p0, Landroid/support/v4/b/b$b;->b:[F

    iget-object v2, p1, Landroid/support/v4/b/b$b;->b:[F
    ...
    iget-object v3, p2, Landroid/support/v4/b/b$b;->b:[F
