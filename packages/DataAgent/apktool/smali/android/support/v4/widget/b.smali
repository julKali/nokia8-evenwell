...
# interfaces
.implements Landroid/support/v4/widget/c$a;
...
.field protected f:Landroid/support/v4/widget/b$a;

.field protected g:Landroid/database/DataSetObserver;

.field protected h:Landroid/support/v4/widget/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/widget/b;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method public a(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/v4/widget/b;->c:Landroid/database/Cursor;
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    iput-boolean v2, p0, Landroid/support/v4/widget/b;->b:Z

    goto :goto_0

    :cond_0
    iput-boolean v1, p0, Landroid/support/v4/widget/b;->b:Z
    ...
    :cond_1
    iput-object p2, p0, Landroid/support/v4/widget/b;->c:Landroid/database/Cursor;
    ...
    :goto_1
    iput p1, p0, Landroid/support/v4/widget/b;->e:I
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/widget/b$a;-><init>(Landroid/support/v4/widget/b;)V

    iput-object p1, p0, Landroid/support/v4/widget/b;->f:Landroid/support/v4/widget/b$a;

    new-instance p1, Landroid/support/v4/widget/b$b;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/b$b;-><init>(Landroid/support/v4/widget/b;)V

    :goto_2
    iput-object p1, p0, Landroid/support/v4/widget/b;->g:Landroid/database/DataSetObserver;
    ...
    :cond_4
    iget-object p1, p0, Landroid/support/v4/widget/b;->g:Landroid/database/DataSetObserver;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iput-boolean p1, p0, Landroid/support/v4/widget/b;->a:Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p1, p0, Landroid/support/v4/widget/b;->d:Landroid/content/Context;

    iget-object p2, p0, Landroid/support/v4/widget/b;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/widget/b;->b(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v4/widget/b;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p2, p1, p3}, Landroid/support/v4/widget/b;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/b;->h:Landroid/support/v4/widget/c;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/widget/c;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/c;-><init>(Landroid/support/v4/widget/c$a;)V

    iput-object v0, p0, Landroid/support/v4/widget/b;->h:Landroid/support/v4/widget/c;
...
.method public getItemId(I)J
    ...
    iget v0, p0, Landroid/support/v4/widget/b;->e:I
