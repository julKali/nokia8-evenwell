...
.field private l:Landroid/support/v4/f/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/f/h<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Landroid/support/v7/widget/h;->d:[I
    ...
    sput-object v3, Landroid/support/v7/widget/h;->e:[I
    ...
    sput-object v3, Landroid/support/v7/widget/h;->f:[I
...
.method private static a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroid/support/v7/widget/h;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3, v0, v3}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p3, v0, v2}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroid/support/v7/widget/ag;->a(Landroid/content/Context;I)I

    move-result p1

    sget-object p3, Landroid/support/v7/widget/h;->a:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p2, p1, p3}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/ag;->c(Landroid/content/Context;I)I
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->m:Ljava/lang/Object;
    ...
    check-cast v1, Landroid/support/v4/f/c;
    ...
    :cond_0
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/f/c;->a(J)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/f/c;->b(J)V
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    check-cast v0, Landroid/support/v4/f/h;
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/f/h;->c(ILjava/lang/Object;)V
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/aj;[I)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/aj;->b:Landroid/graphics/PorterDuff$Mode;

    goto :goto_2

    :cond_4
    sget-object p1, Landroid/support/v7/widget/h;->a:Landroid/graphics/PorterDuff$Mode;

    :goto_2
    invoke-static {v0, p1, p2}, Landroid/support/v7/widget/h;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/h$c;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->k:Landroid/support/v4/f/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->k:Landroid/support/v4/f/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v0, Landroid/support/v7/widget/h;->a:Landroid/graphics/PorterDuff$Mode;

    sget-object v1, Landroid/support/v7/widget/h;->d:[I

    invoke-static {v1, p1}, Landroid/support/v7/widget/h;->a([II)Z
    ...
    :cond_0
    sget-object v1, Landroid/support/v7/widget/h;->f:[I
    ...
    :cond_1
    sget-object v1, Landroid/support/v7/widget/h;->g:[I
    ...
    :cond_5
    invoke-static {p0, v2}, Landroid/support/v7/widget/ag;->a(Landroid/content/Context;I)I

    move-result p0

    invoke-static {p0, v0}, Landroid/support/v7/widget/h;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    new-instance v1, Landroid/support/v4/f/c;

    invoke-direct {v1}, Landroid/support/v4/f/c;-><init>()V

    iget-object v2, p0, Landroid/support/v7/widget/h;->n:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v1, p2, p3, p1}, Landroid/support/v4/f/c;->b(JLjava/lang/Object;)V
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/h;->a(Landroid/util/TypedValue;)J

    move-result-wide v3

    invoke-direct {p0, p1, v3, v4}, Landroid/support/v7/widget/h;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v3, v4, v1}, Landroid/support/v7/widget/h;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/ag;->a:[I
    ...
    sget-object v5, Landroid/support/v7/widget/ag;->e:[I

    aput-object v5, v1, v4

    sget v5, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v5}, Landroid/support/v7/widget/ag;->a(Landroid/content/Context;I)I

    move-result p1

    aput p1, v0, v4

    sget-object p1, Landroid/support/v7/widget/ag;->h:[I
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->l:Landroid/support/v4/f/h;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/widget/h;->l:Landroid/support/v4/f/h;

    invoke-virtual {v0, p2}, Landroid/support/v4/f/h;->a(I)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/h;->k:Landroid/support/v4/f/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->l:Landroid/support/v4/f/h;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/h;->l:Landroid/support/v4/f/h;

    invoke-virtual {v7, p2, v2}, Landroid/support/v4/f/h;->c(ILjava/lang/Object;)V

    iget-object v7, p0, Landroid/support/v7/widget/h;->k:Landroid/support/v4/f/a;

    invoke-virtual {v7, v2}, Landroid/support/v4/f/a;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/support/v7/widget/h$c;
    ...
    invoke-interface {v2, p1, v1, v6, v7}, Landroid/support/v7/widget/h$c;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v3, v4, v5}, Landroid/support/v7/widget/h;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    :try_end_0
    ...
    iget-object p1, p0, Landroid/support/v7/widget/h;->l:Landroid/support/v4/f/h;

    const-string v0, "appcompat_skip_skip"

    invoke-virtual {p1, p2, v0}, Landroid/support/v4/f/h;->c(ILjava/lang/Object;)V
...
.method private e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/f/h;->a(I)Ljava/lang/Object;
...
.method private e(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/h;->p:Z
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/ag;->c(Landroid/content/Context;I)I
    ...
    sget-object p1, Landroid/support/v7/widget/ag;->d:[I
    ...
    sget-object p1, Landroid/support/v7/widget/ag;->b:[I
...
.method a(Landroid/content/Context;Landroid/support/v7/widget/aq;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroid/support/v7/widget/h;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
