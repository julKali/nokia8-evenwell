...
.field g:Landroid/support/v4/widget/b;
...
.method private p()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->g:Landroid/support/v4/widget/b;
    ...
    invoke-direct {v0, v1, p0, v3, v4}, Landroid/support/v7/widget/af;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->g:Landroid/support/v4/widget/b;

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->g:Landroid/support/v4/widget/b;
    ...
    :cond_2
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/af;->a(I)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Landroid/support/v7/widget/x;->onLayout(ZIIII)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/x;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-super {p0}, Landroid/support/v7/widget/x;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/af;
...
.method public setSuggestionsAdapter(Landroid/support/v4/widget/b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->g:Landroid/support/v4/widget/b;
