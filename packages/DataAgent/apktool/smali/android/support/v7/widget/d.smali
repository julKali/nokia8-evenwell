...
.method static synthetic a(Landroid/support/v7/widget/d;)Landroid/support/v7/view/menu/g;
    .locals 0

    iget-object p0, p0, Landroid/support/v7/widget/d;->c:Landroid/support/v7/view/menu/g;
...
.method private a(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/d;->f:Landroid/support/v7/view/menu/n;
...
.method static synthetic b(Landroid/support/v7/widget/d;)Landroid/support/v7/view/menu/g;
    .locals 0
...
.method static synthetic c(Landroid/support/v7/widget/d;)Landroid/support/v7/view/menu/n;
    .locals 0

    iget-object p0, p0, Landroid/support/v7/widget/d;->f:Landroid/support/v7/view/menu/n;

    return-object p0
.end method

.method static synthetic d(Landroid/support/v7/widget/d;)Landroid/support/v7/view/menu/g;
    .locals 0
...
.method static synthetic e(Landroid/support/v7/widget/d;)Landroid/support/v7/view/menu/g;
    .locals 0
...
.method static synthetic f(Landroid/support/v7/widget/d;)Landroid/support/v7/view/menu/n;
    .locals 0
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/n$a;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/d;->f:Landroid/support/v7/view/menu/n;
...
.method public a(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/d;->f:Landroid/support/v7/view/menu/n;
...
.method public a(Landroid/support/v7/view/menu/s;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Landroid/support/v7/view/menu/s;->p()Landroid/view/Menu;
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroid/support/v7/widget/d$a;-><init>(Landroid/support/v7/widget/d;Landroid/content/Context;Landroid/support/v7/view/menu/s;Landroid/view/View;)V
...
.method public b(Z)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/view/menu/g;->j()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Landroid/support/v7/view/menu/h;->a()Landroid/support/v4/g/c;
...
.method public b()Z
    ...
    iget-object v7, v0, Landroid/support/v7/widget/d;->f:Landroid/support/v7/view/menu/n;
...
.method public d()Z
    ...
    iget-object v4, p0, Landroid/support/v7/widget/d;->c:Landroid/support/v7/view/menu/g;
    ...
    invoke-direct/range {v1 .. v6}, Landroid/support/v7/widget/d$e;-><init>(Landroid/support/v7/widget/d;Landroid/content/Context;Landroid/support/v7/view/menu/g;Landroid/view/View;Z)V
