...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/y;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method a(Landroid/content/Context;Z)Landroid/support/v7/widget/u;
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/ab$a;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ab$a;->setHoverListener(Landroid/support/v7/widget/aa;)V
...
.method public a(Landroid/support/v7/view/menu/g;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/aa;->a(Landroid/support/v7/view/menu/g;Landroid/view/MenuItem;)V
...
.method public a(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ab;->g:Landroid/widget/PopupWindow;
...
.method public b(Landroid/support/v7/view/menu/g;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/aa;->b(Landroid/support/v7/view/menu/g;Landroid/view/MenuItem;)V
...
.method public c(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ab;->g:Landroid/widget/PopupWindow;
