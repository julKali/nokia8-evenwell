...
.field b:Landroid/support/v7/view/menu/g$b;
...
.field private f:Landroid/support/v7/widget/w;
...
.method private f()V
    ...
    :goto_2
    invoke-static {p0, v1}, Landroid/support/v7/widget/an;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_5
    invoke-static {p0, v2}, Landroid/support/v7/widget/an;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public a(Landroid/support/v7/view/menu/h;I)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Landroid/support/v7/widget/w;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Landroid/support/v7/widget/w;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Landroid/support/v7/view/menu/g$b;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/q;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v1, v2, v3, v4}, Landroid/support/v7/widget/q;->setPadding(IIII)V

    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/q;->onMeasure(II)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Landroid/support/v7/widget/q;->setPadding(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Landroid/support/v7/widget/w;
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/v7/widget/q;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setItemInvoker(Landroid/support/v7/view/menu/g$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Landroid/support/v7/view/menu/g$b;
...
.method public setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/q;->setPadding(IIII)V
