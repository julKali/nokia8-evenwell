...
# instance fields
.field private b:Landroid/support/b/a/i$g;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;
...
.method constructor <init>(Landroid/support/b/a/i$g;)V
    ...
    iput-object p1, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    iget-object v0, p0, Landroid/support/b/a/i;->d:Landroid/graphics/PorterDuffColorFilter;

    iget-object v1, p1, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object p1, p1, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/b/a/i;
    ...
    iget-object p1, v0, Landroid/support/b/a/i;->c:Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object p0, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;
    ...
    invoke-static {p1, p2, v1, v2, v3}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I

    move-result v1

    sget-object v2, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v1, v2}, Landroid/support/b/a/i;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v1

    iput-object v1, p0, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v1, p0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v3, p0, Landroid/support/b/a/i$g;->e:Z

    invoke-static {p1, p2, v1, v2, v3}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/b/a/i$g;->e:Z

    const-string p0, "viewportWidth"

    const/4 v1, 0x7

    iget v2, v0, Landroid/support/b/a/i$f;->f:F

    invoke-static {p1, p2, p0, v1, v2}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result p0

    iput p0, v0, Landroid/support/b/a/i$f;->f:F

    const-string p0, "viewportHeight"

    const/16 v1, 0x8

    iget v2, v0, Landroid/support/b/a/i$f;->g:F

    invoke-static {p1, p2, p0, v1, v2}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result p0

    iput p0, v0, Landroid/support/b/a/i$f;->g:F

    iget p0, v0, Landroid/support/b/a/i$f;->f:F
    ...
    iget p0, v0, Landroid/support/b/a/i$f;->g:F
    ...
    iget v2, v0, Landroid/support/b/a/i$f;->d:F

    invoke-virtual {p1, p0, v2}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result p0

    iput p0, v0, Landroid/support/b/a/i$f;->d:F

    const/4 p0, 0x2

    iget v2, v0, Landroid/support/b/a/i$f;->e:F

    invoke-virtual {p1, p0, v2}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result p0

    iput p0, v0, Landroid/support/b/a/i$f;->e:F

    iget p0, v0, Landroid/support/b/a/i$f;->d:F

    cmpg-float p0, p0, v1

    if-lez p0, :cond_3

    iget p0, v0, Landroid/support/b/a/i$f;->e:F
    ...
    invoke-virtual {v0}, Landroid/support/b/a/i$f;->getAlpha()F
    ...
    invoke-virtual {v0, p0}, Landroid/support/b/a/i$f;->setAlpha(F)V
    ...
    iput-object p0, v0, Landroid/support/b/a/i$f;->i:Ljava/lang/String;

    iget-object p1, v0, Landroid/support/b/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {p1, p0, v0}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a()Z
    ...
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/a;->g(Landroid/graphics/drawable/Drawable;)I
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v2, v0, Landroid/support/b/a/i$f;->c:Landroid/support/b/a/i$c;
    ...
    check-cast v6, Landroid/support/b/a/i$c;
    ...
    invoke-direct {v2}, Landroid/support/b/a/i$b;-><init>()V

    invoke-virtual {v2, p1, p3, p4, p2}, Landroid/support/b/a/i$b;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v5, v6, Landroid/support/b/a/i$c;->b:Ljava/util/ArrayList;

    invoke-virtual {v5, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v2}, Landroid/support/b/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v5

    if-eqz v5, :cond_1

    iget-object v5, v0, Landroid/support/b/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {v2}, Landroid/support/b/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v5, v6, v2}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    const/4 v5, 0x0

    iget v6, p0, Landroid/support/b/a/i$g;->a:I

    iget v2, v2, Landroid/support/b/a/i$b;->o:I
    ...
    invoke-direct {v2}, Landroid/support/b/a/i$a;-><init>()V

    invoke-virtual {v2, p1, p3, p4, p2}, Landroid/support/b/a/i$a;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v6, v6, Landroid/support/b/a/i$c;->b:Ljava/util/ArrayList;

    invoke-virtual {v6, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v2}, Landroid/support/b/a/i$a;->getPathName()Ljava/lang/String;

    move-result-object v6

    if-eqz v6, :cond_3

    iget-object v6, v0, Landroid/support/b/a/i$f;->k:Landroid/support/v4/d/a;

    invoke-virtual {v2}, Landroid/support/b/a/i$a;->getPathName()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v6, v7, v2}, Landroid/support/v4/d/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_3
    iget v6, p0, Landroid/support/b/a/i$g;->a:I

    iget v2, v2, Landroid/support/b/a/i$a;->o:I

    :goto_1
    or-int/2addr v2, v6

    iput v2, p0, Landroid/support/b/a/i$g;->a:I
    ...
    new-instance v2, Landroid/support/b/a/i$c;

    invoke-direct {v2}, Landroid/support/b/a/i$c;-><init>()V

    invoke-virtual {v2, p1, p3, p4, p2}, Landroid/support/b/a/i$c;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {v2}, Landroid/support/b/a/i$c;->getGroupName()Ljava/lang/String;
    ...
    iget v2, v2, Landroid/support/b/a/i$c;->e:I
...
.method a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroid/support/b/a/i$f;->k:Landroid/support/v4/d/a;
...
.method public canApplyTheme()Z
    ...
    iget-object v0, p0, Landroid/support/b/a/i;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    iget-object p0, p0, Landroid/support/b/a/i;->c:Landroid/graphics/drawable/Drawable;

    invoke-static {p0}, Landroid/support/v4/graphics/drawable/a;->d(Landroid/graphics/drawable/Drawable;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    invoke-virtual {v2, v1, v3}, Landroid/support/b/a/i$g;->b(II)V
    ...
    invoke-virtual {v2, v1, v3}, Landroid/support/b/a/i$g;->a(II)V
    ...
    invoke-virtual {v2}, Landroid/support/b/a/i$g;->b()Z
    ...
    iget-object v1, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    invoke-virtual {v1}, Landroid/support/b/a/i$g;->c()V

    :cond_8
    :goto_1
    iget-object v1, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    iget-object p0, p0, Landroid/support/b/a/i;->k:Landroid/graphics/Rect;

    invoke-virtual {v1, p1, v0, p0}, Landroid/support/b/a/i$g;->a(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
...
.method public getAlpha()I
    ...
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/a;->c(Landroid/graphics/drawable/Drawable;)I
...
.method public getChangingConfigurations()I
    ...
    invoke-virtual {p0}, Landroid/support/b/a/i$g;->getChangingConfigurations()I
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    invoke-direct {v0, p0}, Landroid/support/b/a/i$h;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    return-object v0

    :cond_0
    iget-object v0, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    invoke-virtual {p0}, Landroid/support/b/a/i;->getChangingConfigurations()I

    move-result v1

    iput v1, v0, Landroid/support/b/a/i$g;->a:I
...
.method public getIntrinsicHeight()I
    ...
    iget p0, p0, Landroid/support/b/a/i$f;->e:F
...
.method public getIntrinsicWidth()I
    ...
    iget p0, p0, Landroid/support/b/a/i$f;->d:F
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iput-object v1, v0, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;
    ...
    iput-boolean v1, v0, Landroid/support/b/a/i$g;->k:Z
    ...
    iget-object p2, v0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object p3, v0, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
...
.method public isAutoMirrored()Z
    ...
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/a;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-boolean p0, p0, Landroid/support/b/a/i$g;->e:Z
...
.method public isStateful()Z
    ...
    invoke-virtual {v0}, Landroid/support/b/a/i$g;->d()Z
    ...
    iget-object v0, v0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    if-eqz v0, :cond_1

    iget-object p0, p0, Landroid/support/b/a/i;->b:Landroid/support/b/a/i$g;

    iget-object p0, p0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;
...
.method protected onStateChange([I)Z
    ...
    iget-object v2, v1, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    const/4 v3, 0x1

    if-eqz v2, :cond_1

    iget-object v2, v1, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v4, v1, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v0, v2, v4}, Landroid/support/b/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v0

    iput-object v0, p0, Landroid/support/b/a/i;->d:Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_1
    invoke-virtual {v1}, Landroid/support/b/a/i$g;->d()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1, p1}, Landroid/support/b/a/i$g;->a([I)Z
...
.method public setAlpha(I)V
    ...
    iget-object v0, v0, Landroid/support/b/a/i$g;->b:Landroid/support/b/a/i$f;
...
.method public setAutoMirrored(Z)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;Z)V
...
.method public setTint(I)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;I)V
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Landroid/support/b/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/b/a/i;->d:Landroid/graphics/PorterDuffColorFilter;

    iget-object v0, v0, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Landroid/support/b/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
