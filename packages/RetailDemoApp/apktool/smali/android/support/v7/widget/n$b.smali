...
.method a(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/e/p;->k(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p0, p0, Landroid/support/v7/widget/n$b;->i:Landroid/graphics/Rect;
...
.method public b()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/n$b;->h:Ljava/lang/CharSequence;
...
.method f()V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/n;->c:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroid/support/v7/widget/n$b;->b:Landroid/support/v7/widget/n;

    invoke-static {v0}, Landroid/support/v7/widget/ap;->a(Landroid/view/View;)Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/n;->c:Landroid/graphics/Rect;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/n;->c:Landroid/graphics/Rect;
    ...
    iget v4, v4, Landroid/support/v7/widget/n;->b:I
    ...
    iget-object v6, v6, Landroid/support/v7/widget/n;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v4}, Landroid/support/v7/widget/ap;->a(Landroid/view/View;)Z
