...
# interfaces
.implements Landroid/support/v4/e/l;
...
.field private i:Landroid/support/v7/widget/r;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/e/n;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/e/n;

    return-void
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/r;
    .locals 2

    instance-of p0, p1, Landroid/support/v7/widget/r;
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/Toolbar;->getWrapper()Landroid/support/v7/widget/r;
...
.method private a(FF)Z
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->a:Landroid/support/v7/widget/ActionBarContainer;
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    iget p3, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->leftMargin:I
    ...
    iput p3, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->leftMargin:I
    ...
    iget p4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->topMargin:I
    ...
    iput p3, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->topMargin:I
    ...
    iget p4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->rightMargin:I
    ...
    iput p3, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->rightMargin:I
    ...
    iget p4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->bottomMargin:I
    ...
    iput p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->bottomMargin:I
...
# virtual methods
.method protected a()Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    .locals 1

    new-instance p0, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    const/4 v0, -0x1

    invoke-direct {p0, v0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout$b;-><init>(II)V
...
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$b;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method b()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/r;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/r;
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of p0, p1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->j:Landroid/graphics/drawable/Drawable;
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/e/p;->e(Landroid/view/View;)I
    ...
    invoke-static {p0, p1, v1}, Landroid/support/v7/widget/ap;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a()Landroid/support/v7/widget/ActionBarOverlayLayout$b;
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$b;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/e/n;

    invoke-virtual {p0}, Landroid/support/v4/e/n;->a()I
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/r;

    invoke-interface {p0}, Landroid/support/v7/widget/r;->a()Ljava/lang/CharSequence;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/e/p;->f(Landroid/view/View;)V
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/e/n;

    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/e/n;->a(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v7/widget/ActionBarOverlayLayout$a;

    invoke-interface {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->c()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-interface {p0}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->d()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    invoke-interface {p1, v3}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->a(Z)V
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->b()V
...
.method protected onWindowVisibilityChanged(I)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->a(I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/widget/r;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/widget/r;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/widget/r;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/widget/r;->a(Landroid/view/Window$Callback;)V
...
.method public setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v7/widget/r;->a(Ljava/lang/CharSequence;)V
