...
.method public constructor <init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/n$a;->a:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/n$a;->b:Landroid/widget/ListAdapter;
    ...
    :cond_1
    instance-of p0, p1, Landroid/support/v7/widget/af;

    if-eqz p0, :cond_2

    check-cast p1, Landroid/support/v7/widget/af;

    invoke-interface {p1}, Landroid/support/v7/widget/af;->a()Landroid/content/res/Resources$Theme;

    move-result-object p0

    if-nez p0, :cond_2

    invoke-interface {p1, p2}, Landroid/support/v7/widget/af;->a(Landroid/content/res/Resources$Theme;)V
...
.method public areAllItemsEnabled()Z
    ...
    iget-object p0, p0, Landroid/support/v7/widget/n$a;->b:Landroid/widget/ListAdapter;
...
.method public getCount()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/n$a;->a:Landroid/widget/SpinnerAdapter;
    ...
    :cond_0
    iget-object p0, p0, Landroid/support/v7/widget/n$a;->a:Landroid/widget/SpinnerAdapter;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/n$a;->getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public isEmpty()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/n$a;->getCount()I
