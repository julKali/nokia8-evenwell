...
.method private c()V
    ...
    iget-object p0, p0, Landroid/support/v7/widget/d;->c:Ljava/lang/String;
...
.method private e()Z
    ...
    iget-object p0, p0, Landroid/support/v7/widget/d;->i:Ljava/util/List;

    invoke-static {p0}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p0

    invoke-interface {v0, v1, v2, p0}, Landroid/support/v7/widget/d$b;->a(Landroid/content/Intent;Ljava/util/List;Ljava/util/List;)V
...
.method private h()V
    ...
    check-cast v3, Landroid/support/v7/widget/d$c;
...
.method public a()I
    ...
    iget-object p0, p0, Landroid/support/v7/widget/d;->h:Ljava/util/List;
...
.method public a(Landroid/content/pm/ResolveInfo;)I
    ...
    iget-object v3, v3, Landroid/support/v7/widget/d$a;->a:Landroid/content/pm/ResolveInfo;
...
.method public a(I)Landroid/content/pm/ResolveInfo;
    ...
    check-cast p0, Landroid/support/v7/widget/d$a;

    iget-object p0, p0, Landroid/support/v7/widget/d$a;->a:Landroid/content/pm/ResolveInfo;
...
.method public b(I)Landroid/content/Intent;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/d;->p:Landroid/support/v7/widget/d$d;
    ...
    invoke-interface {v4, p0, v3}, Landroid/support/v7/widget/d$d;->a(Landroid/support/v7/widget/d;Landroid/content/Intent;)Z
    ...
    invoke-direct {p0, v2}, Landroid/support/v7/widget/d;->a(Landroid/support/v7/widget/d$c;)Z
...
.method public c(I)V
    ...
    new-instance p1, Landroid/support/v7/widget/d$c;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    invoke-direct {p1, v2, v3, v4, v1}, Landroid/support/v7/widget/d$c;-><init>(Landroid/content/ComponentName;JF)V

    invoke-direct {p0, p1}, Landroid/support/v7/widget/d;->a(Landroid/support/v7/widget/d$c;)Z
