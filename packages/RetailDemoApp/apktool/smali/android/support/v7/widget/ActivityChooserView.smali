...
.field d:Landroid/support/v4/e/c;
...
.field private n:Landroid/support/v7/widget/x;
...
.method a(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/x;

    move-result-object p1

    invoke-virtual {p1}, Landroid/support/v7/widget/x;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/x;->g(I)V

    invoke-virtual {p1}, Landroid/support/v7/widget/x;->a()V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v4/e/c;

    if-eqz v0, :cond_4

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v4/e/c;

    invoke-virtual {v0, v2}, Landroid/support/v4/e/c;->a(Z)V

    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/x;->e()Landroid/widget/ListView;
...
.method public b()Z
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method getListPopupWindow()Landroid/support/v7/widget/x;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/x;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/x;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/x;->b(Landroid/view/View;)V
    ...
    :cond_0
    iget-object p0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/x;
...
.method public setExpandActivityOverflowButtonContentDescription(I)V
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/widget/ImageView;
...
.method public setProvider(Landroid/support/v4/e/c;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v4/e/c;
