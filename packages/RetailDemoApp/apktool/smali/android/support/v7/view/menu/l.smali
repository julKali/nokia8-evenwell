...
.method private a(IIZZ)V
    ...
    iget p3, p0, Landroid/support/v7/view/menu/l;->g:I

    iget-object p4, p0, Landroid/support/v7/view/menu/l;->f:Landroid/view/View;

    invoke-static {p4}, Landroid/support/v4/e/p;->b(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Landroid/support/v4/e/d;->a(II)I
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/l;->f:Landroid/view/View;
    ...
    iget-object p0, p0, Landroid/support/v7/view/menu/l;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/view/menu/k;->a(Landroid/graphics/Rect;)V
...
.method private g()Landroid/support/v7/view/menu/k;
    ...
    iget-object v8, p0, Landroid/support/v7/view/menu/l;->a:Landroid/content/Context;

    iget-object v9, p0, Landroid/support/v7/view/menu/l;->b:Landroid/support/v7/view/menu/g;

    iget-object v10, p0, Landroid/support/v7/view/menu/l;->f:Landroid/view/View;

    iget v11, p0, Landroid/support/v7/view/menu/l;->d:I

    iget v12, p0, Landroid/support/v7/view/menu/l;->e:I

    iget-boolean v13, p0, Landroid/support/v7/view/menu/l;->c:Z

    move-object v7, v0

    invoke-direct/range {v7 .. v13}, Landroid/support/v7/view/menu/r;-><init>(Landroid/content/Context;Landroid/support/v7/view/menu/g;Landroid/view/View;IIZ)V
    ...
    iget p0, p0, Landroid/support/v7/view/menu/l;->g:I

    invoke-virtual {v0, p0}, Landroid/support/v7/view/menu/k;->a(I)V
...
.method public a(Landroid/support/v7/view/menu/m$a;)V
    ...
    iget-object p0, p0, Landroid/support/v7/view/menu/l;->j:Landroid/support/v7/view/menu/k;

    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/k;->a(Landroid/support/v7/view/menu/m$a;)V
...
.method public a(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/k;->a(Z)V
...
.method public a(II)Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->f:Landroid/view/View;
    ...
    :cond_1
    invoke-direct {p0, p1, p2, v1, v1}, Landroid/support/v7/view/menu/l;->a(IIZZ)V
...
.method public c()Z
    ...
    :cond_1
    invoke-direct {p0, v2, v2, v2, v2}, Landroid/support/v7/view/menu/l;->a(IIZZ)V
...
.method public d()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/k;->c()V
...
.method protected e()V
    ...
    iget-object p0, p0, Landroid/support/v7/view/menu/l;->k:Landroid/widget/PopupWindow$OnDismissListener;
