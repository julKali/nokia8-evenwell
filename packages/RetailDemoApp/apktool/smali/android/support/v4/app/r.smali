...
.method protected static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroid/support/v4/app/r;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroid/support/v4/app/r;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Landroid/support/v4/e/p;->d(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Landroid/support/v4/e/p;->a(Landroid/view/View;Ljava/lang/String;)V
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3}, Landroid/support/v4/e/p;->d(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Landroid/support/v4/e/p;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4}, Landroid/support/v4/e/p;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroid/support/v4/app/r$1;
    ...
    invoke-static {p1, p5}, Landroid/support/v4/app/x;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroid/support/v4/app/x;
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroid/support/v4/app/r$2;-><init>(Landroid/support/v4/app/r;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Landroid/support/v4/app/x;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroid/support/v4/app/x;
...
.method a(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroid/support/v4/app/r$3;-><init>(Landroid/support/v4/app/r;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroid/support/v4/e/r;->a(Landroid/view/ViewGroup;)Z
...
.method a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroid/support/v4/e/p;->d(Landroid/view/View;)Ljava/lang/String;
