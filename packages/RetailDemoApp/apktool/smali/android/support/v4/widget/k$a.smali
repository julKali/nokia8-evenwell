...
.method constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/k$a;->a:Landroid/view/ActionMode$Callback;

    iput-object p2, p0, Landroid/support/v4/widget/k$a;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    iput-boolean p1, p0, Landroid/support/v4/widget/k$a;->f:Z
...
.method private a(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/k$a;->a()Landroid/content/Intent;

    move-result-object v0

    const-string v1, "android.intent.extra.PROCESS_TEXT_READONLY"

    invoke-direct {p0, p2}, Landroid/support/v4/widget/k$a;->a(Landroid/widget/TextView;)Z
...
.method private a(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-direct {p0, v1, p1}, Landroid/support/v4/widget/k$a;->a(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method private a(Landroid/view/Menu;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/k$a;->b:Landroid/widget/TextView;
    ...
    iget-boolean v2, p0, Landroid/support/v4/widget/k$a;->f:Z
    ...
    iput-boolean v4, p0, Landroid/support/v4/widget/k$a;->f:Z
    ...
    iput-object v2, p0, Landroid/support/v4/widget/k$a;->c:Ljava/lang/Class;

    iget-object v2, p0, Landroid/support/v4/widget/k$a;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/k$a;->d:Ljava/lang/reflect/Method;

    iput-boolean v4, p0, Landroid/support/v4/widget/k$a;->e:Z
    :try_end_0
    ...
    iput-boolean v3, p0, Landroid/support/v4/widget/k$a;->e:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Landroid/support/v4/widget/k$a;->e:Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/k$a;->d:Ljava/lang/reflect/Method;
    ...
    :cond_3
    invoke-direct {p0, v0, v1}, Landroid/support/v4/widget/k$a;->a(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Landroid/support/v4/widget/k$a;->b:Landroid/widget/TextView;

    invoke-direct {p0, v5, v7}, Landroid/support/v4/widget/k$a;->a(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    iget-object p0, p0, Landroid/support/v4/widget/k$a;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-direct {p0, p2}, Landroid/support/v4/widget/k$a;->a(Landroid/view/Menu;)V
