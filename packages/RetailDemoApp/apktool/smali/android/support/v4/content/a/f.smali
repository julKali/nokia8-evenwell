...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroid/support/v4/content/a/f$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v13, v10}, Landroid/support/v4/content/a/f$a;->a(ILandroid/os/Handler;)V

    :cond_0
    return-object v12

    :cond_1
    invoke-static {p1, v4, v5}, Landroid/support/v4/graphics/c;->a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v1, v10}, Landroid/support/v4/content/a/f$a;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-static {v1, p1}, Landroid/support/v4/content/a/c;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/a/c$a;
    ...
    invoke-static/range {v1 .. v8}, Landroid/support/v4/graphics/c;->a(Landroid/content/Context;Landroid/support/v4/content/a/c$a;Landroid/content/res/Resources;IILandroid/support/v4/content/a/f$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-static {p0, p1, v4, v11, v5}, Landroid/support/v4/graphics/c;->a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v9, v0, v10}, Landroid/support/v4/content/a/f$a;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
