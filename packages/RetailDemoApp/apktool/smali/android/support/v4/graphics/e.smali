...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/b/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/d/k;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v4}, Landroid/support/v4/graphics/i;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Landroid/support/v4/d/k;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    invoke-virtual {v3}, Landroid/support/v4/b/b$b;->b()I

    move-result v4

    invoke-virtual {v3}, Landroid/support/v4/b/b$b;->c()I

    move-result v6

    invoke-virtual {v3}, Landroid/support/v4/b/b$b;->d()Z

    move-result v3

    invoke-static {p0, v5, v4, v6, v3}, Landroid/support/v4/graphics/e;->a(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :cond_2
    invoke-static {p0}, Landroid/support/v4/graphics/e;->a(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public a(Landroid/content/Context;Landroid/support/v4/content/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v1}, Landroid/support/v4/content/a/c$c;->f()I

    move-result v2

    invoke-static {p1, p3, v2}, Landroid/support/v4/graphics/i;->a(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    :cond_0
    invoke-virtual {v1}, Landroid/support/v4/content/a/c$c;->e()I

    move-result v4

    invoke-virtual {v1}, Landroid/support/v4/content/a/c$c;->b()I

    move-result v5

    invoke-virtual {v1}, Landroid/support/v4/content/a/c$c;->c()Z

    move-result v1

    invoke-static {p0, v2, v4, v5, v1}, Landroid/support/v4/graphics/e;->a(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
