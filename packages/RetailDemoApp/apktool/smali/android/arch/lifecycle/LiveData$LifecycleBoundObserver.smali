...
.method public a(Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/c$a;)V
    ...
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->c:Landroid/arch/lifecycle/k;

    invoke-virtual {p1, p0}, Landroid/arch/lifecycle/LiveData;->a(Landroid/arch/lifecycle/k;)V
...
.method a()Z
    ...
    iget-object p0, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->a:Landroid/arch/lifecycle/e;

    invoke-interface {p0}, Landroid/arch/lifecycle/e;->a()Landroid/arch/lifecycle/c;

    move-result-object p0

    invoke-virtual {p0}, Landroid/arch/lifecycle/c;->a()Landroid/arch/lifecycle/c$b;

    move-result-object p0

    sget-object v0, Landroid/arch/lifecycle/c$b;->d:Landroid/arch/lifecycle/c$b;

    invoke-virtual {p0, v0}, Landroid/arch/lifecycle/c$b;->a(Landroid/arch/lifecycle/c$b;)Z
