...
.method private a(Landroid/arch/lifecycle/c$a;)V
    ...
    instance-of v0, p0, Landroid/arch/lifecycle/g;

    if-eqz v0, :cond_0

    check-cast p0, Landroid/arch/lifecycle/g;

    invoke-interface {p0}, Landroid/arch/lifecycle/g;->b()Landroid/arch/lifecycle/f;
    ...
    :cond_0
    instance-of v0, p0, Landroid/arch/lifecycle/e;

    if-eqz v0, :cond_1

    check-cast p0, Landroid/arch/lifecycle/e;

    invoke-interface {p0}, Landroid/arch/lifecycle/e;->a()Landroid/arch/lifecycle/c;

    move-result-object p0

    instance-of v0, p0, Landroid/arch/lifecycle/f;
