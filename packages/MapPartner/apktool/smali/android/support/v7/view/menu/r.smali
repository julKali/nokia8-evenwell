.class public Landroid/support/v7/view/menu/r;
...
.method a(Landroid/view/ActionProvider;)Landroid/support/v7/view/menu/s;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/r;->a:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Landroid/support/v7/view/menu/s;-><init>(Landroid/support/v7/view/menu/r;Landroid/content/Context;Landroid/view/ActionProvider;)V
...
.method public a(Z)V
    ...
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->c:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/r;->c:Ljava/lang/reflect/Method;
...
.method public getActionProvider()Landroid/view/ActionProvider;
    ...
    invoke-interface {v0}, Landroid/support/v4/c/a/b;->a()Landroid/support/v4/f/q;

    move-result-object v0

    instance-of v1, v0, Landroid/support/v7/view/menu/s;

    if-eqz v1, :cond_0

    check-cast v0, Landroid/support/v7/view/menu/s;

    iget-object v0, v0, Landroid/support/v7/view/menu/s;->a:Landroid/view/ActionProvider;
...
.method public getActionView()Landroid/view/View;
    ...
    instance-of v1, v0, Landroid/support/v7/view/menu/t;

    if-eqz v1, :cond_0

    check-cast v0, Landroid/support/v7/view/menu/t;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/t;->c()Landroid/view/View;
...
.method public setActionProvider(Landroid/view/ActionProvider;)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/r;->a(Landroid/view/ActionProvider;)Landroid/support/v7/view/menu/s;

    move-result-object v1

    :goto_0
    invoke-interface {v0, v1}, Landroid/support/v4/c/a/b;->a(Landroid/support/v4/f/q;)Landroid/support/v4/c/a/b;
...
.method public setActionView(I)Landroid/view/MenuItem;
    ...
    new-instance v2, Landroid/support/v7/view/menu/t;

    invoke-direct {v2, v1}, Landroid/support/v7/view/menu/t;-><init>(Landroid/view/View;)V
...
.method public setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/view/menu/t;-><init>(Landroid/view/View;)V
...
.method public setOnActionExpandListener(Landroid/view/MenuItem$OnActionExpandListener;)Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v7/view/menu/u;-><init>(Landroid/support/v7/view/menu/r;Landroid/view/MenuItem$OnActionExpandListener;)V

    :goto_0
    invoke-interface {v0, v1}, Landroid/support/v4/c/a/b;->a(Landroid/support/v4/f/ai;)Landroid/support/v4/c/a/b;
...
.method public setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v7/view/menu/v;-><init>(Landroid/support/v7/view/menu/r;Landroid/view/MenuItem$OnMenuItemClickListener;)V
