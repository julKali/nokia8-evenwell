...
# instance fields
.field private b:Landroid/support/v7/view/menu/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v0, p3, v2}, Landroid/support/v7/widget/cy;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/cy;
    ...
    :cond_0
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/cy;->f(I)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/cy;->a(I)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ExpandedMenuView;->b:Landroid/support/v7/view/menu/m;
