.class synthetic Landroid/os/BundleProto$1;
...
# static fields
.field static final synthetic $SwitchMap$android$os$BundleProto$DataCase:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/os/BundleProto$1;->$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Landroid/os/BundleProto$1;->$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke:[I
    ...
    :try_start_1
    sget-object v2, Landroid/os/BundleProto$1;->$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke:[I
    ...
    :try_start_2
    sget-object v3, Landroid/os/BundleProto$1;->$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke:[I
    ...
    .line 381
    :goto_7
    invoke-static {}, Landroid/os/BundleProto$DataCase;->values()[Landroid/os/BundleProto$DataCase;
    ...
    sput-object v3, Landroid/os/BundleProto$1;->$SwitchMap$android$os$BundleProto$DataCase:[I

    :try_start_8
    sget-object v3, Landroid/os/BundleProto$1;->$SwitchMap$android$os$BundleProto$DataCase:[I

    sget-object v4, Landroid/os/BundleProto$DataCase;->PARCELLED_DATA_SIZE:Landroid/os/BundleProto$DataCase;

    invoke-virtual {v4}, Landroid/os/BundleProto$DataCase;->ordinal()I
    ...
    :goto_8
    :try_start_9
    sget-object v0, Landroid/os/BundleProto$1;->$SwitchMap$android$os$BundleProto$DataCase:[I

    sget-object v3, Landroid/os/BundleProto$DataCase;->MAP_DATA:Landroid/os/BundleProto$DataCase;

    invoke-virtual {v3}, Landroid/os/BundleProto$DataCase;->ordinal()I
    ...
    invoke-virtual {v1}, Landroid/os/BundleProto$DataCase;->ordinal()I
