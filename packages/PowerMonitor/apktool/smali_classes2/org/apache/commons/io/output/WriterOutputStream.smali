...
.method private static checkIbmJdkWithBrokenUTF16(Ljava/nio/charset/Charset;)V
    ...
    .line 319
    .local v2, "charsetDecoder2":Ljava/nio/charset/CharsetDecoder;
    const/16 v3, 0x10
    ...
    .line 320
    .local v3, "bb2":Ljava/nio/ByteBuffer;
    const-string v4, "v\u00e9s"
    ...
    .line 321
    .local v4, "cb2":Ljava/nio/CharBuffer;
    array-length v5, v1
    ...
    :goto_1
    :try_start_0
    invoke-virtual {v2, v3, v4, v8}, Ljava/nio/charset/CharsetDecoder;->decode(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Ljava/nio/charset/CoderResult;
    :try_end_0
