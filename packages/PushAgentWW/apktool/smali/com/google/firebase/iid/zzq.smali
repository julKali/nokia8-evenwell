...
# static fields
.field private static zzmma:Lcom/google/firebase/iid/zzq;


# instance fields
.field private final zzmmb:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzmmc:Ljava/lang/Boolean;

.field final zzmmd:Ljava/util/Queue;
...
.field private zzmme:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmmb:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmmc:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmmd:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmme:Ljava/util/Queue;
...
.method public static zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p0, v0, v1, p2, v2}, Lcom/google/firebase/iid/zzq;->zza(Landroid/content/Context;ILjava/lang/String;Landroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public static zzb(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p0, p1, v0, p2, v1}, Lcom/google/firebase/iid/zzq;->zza(Landroid/content/Context;ILjava/lang/String;Landroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public static declared-synchronized zzbys()Lcom/google/firebase/iid/zzq;
    .locals 2

    const-class v1, Lcom/google/firebase/iid/zzq;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/zzq;->zzmma:Lcom/google/firebase/iid/zzq;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/firebase/iid/zzq;

    invoke-direct {v0}, Lcom/google/firebase/iid/zzq;-><init>()V

    sput-object v0, Lcom/google/firebase/iid/zzq;->zzmma:Lcom/google/firebase/iid/zzq;
...
.method private final zzf(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzq;->zzmmb:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmmb:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_0
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmmc:Ljava/lang/Boolean;
    ...
    :try_start_3
    iget-object v3, p0, Lcom/google/firebase/iid/zzq;->zzmmb:Landroid/support/v4/util/SimpleArrayMap;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmmd:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/iid/zzq;->zzf(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzmme:Ljava/util/Queue;
...
.method public final zzbyt()Landroid/content/Intent;
    .locals 1
