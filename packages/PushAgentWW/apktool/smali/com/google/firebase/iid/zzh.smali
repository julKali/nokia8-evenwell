...
.field private final zzmld:Landroid/content/Intent;

.field private final zzmle:Ljava/util/concurrent/ScheduledExecutorService;

.field private final zzmlf:Ljava/util/Queue;
...
.field private zzmlg:Lcom/google/firebase/iid/zzf;

.field private zzmlh:Z
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzmlf:Ljava/util/Queue;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/firebase/iid/zzh;->zzmlh:Z

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzahy:Landroid/content/Context;

    new-instance v0, Landroid/content/Intent;

    invoke-direct {v0, p2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/google/firebase/iid/zzh;->zzahy:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzmld:Landroid/content/Intent;

    iput-object p3, p0, Lcom/google/firebase/iid/zzh;->zzmle:Ljava/util/concurrent/ScheduledExecutorService;

    return-void
.end method

.method private final declared-synchronized zzbyj()V
    .locals 4
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzh;->zzmlf:Ljava/util/Queue;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzh;->zzmlg:Lcom/google/firebase/iid/zzf;
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzmlg:Lcom/google/firebase/iid/zzf;
    ...
    iget-boolean v0, p0, Lcom/google/firebase/iid/zzh;->zzmlh:Z
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzmld:Landroid/content/Intent;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object p2, p0, Lcom/google/firebase/iid/zzh;->zzmlg:Lcom/google/firebase/iid/zzf;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/iid/zzh;->zzbyj()V
...
.method public final declared-synchronized zza(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzmle:Ljava/util/concurrent/ScheduledExecutorService;
