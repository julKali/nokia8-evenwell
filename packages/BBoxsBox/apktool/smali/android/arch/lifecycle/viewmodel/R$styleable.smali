...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout:[I

    .line 472
    const/4 v1, 0x0

    sput v1, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_keylines:I

    .line 488
    const/4 v2, 0x1

    sput v2, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_statusBarBackground:I
    ...
    sput-object v4, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout:[I

    .line 531
    sput v1, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_layout_anchor:I

    .line 568
    sput v2, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_layout_anchorGravity:I

    .line 580
    sput v0, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_layout_behavior:I

    .line 604
    const/4 v4, 0x3

    sput v4, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_layout_dodgeInsetEdges:I

    .line 628
    const/4 v5, 0x4

    sput v5, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_layout_insetEdge:I

    .line 640
    const/4 v6, 0x5

    sput v6, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_layout_keyline:I

    .line 669
    const/4 v7, 0x6

    sput v7, Landroid/arch/lifecycle/viewmodel/R$styleable;->CoordinatorLayout_Layout_android_layout_gravity:I
    ...
    sput-object v8, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamily:[I
    ...
    .line 754
    sput v0, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamily_fontProviderFetchStrategy:I
    ...
    sput-object v9, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamilyFont:[I
    ...
    .line 879
    sput v0, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamilyFont_fontVariationSettings:I
    ...
    .line 925
    sput v7, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamilyFont_android_fontWeight:I

    .line 943
    sput v3, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamilyFont_android_fontStyle:I

    .line 952
    const/16 v9, 0x8

    sput v9, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamilyFont_android_ttcIndex:I

    .line 962
    const/16 v10, 0x9

    sput v10, Landroid/arch/lifecycle/viewmodel/R$styleable;->FontFamilyFont_android_fontVariationSettings:I
    ...
    sput-object v11, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView:[I

    .line 1008
    sput v1, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_fastScrollEnabled:I

    .line 1020
    sput v2, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_fastScrollHorizontalThumbDrawable:I

    .line 1032
    sput v0, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_fastScrollHorizontalTrackDrawable:I

    .line 1044
    sput v4, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_fastScrollVerticalThumbDrawable:I

    .line 1056
    sput v5, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_fastScrollVerticalTrackDrawable:I

    .line 1075
    sput v6, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_layoutManager:I

    .line 1085
    sput v7, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_reverseLayout:I

    .line 1094
    sput v3, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_spanCount:I

    .line 1104
    sput v9, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_stackFromEnd:I

    .line 1121
    sput v10, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_android_orientation:I

    .line 1139
    sput v8, Landroid/arch/lifecycle/viewmodel/R$styleable;->RecyclerView_android_descendantFocusability:I
