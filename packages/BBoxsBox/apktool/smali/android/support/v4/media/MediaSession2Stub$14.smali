...
.method public run(Landroid/support/v4/media/MediaSession2$ControllerInfo;)V
    ...
    const-string v2, "prepareFromUri(): Ignoring null uri from "
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaSession2Stub$14;->val$extras:Landroid/os/Bundle;

    invoke-virtual {v0, v1, p1, v2, v3}, Landroid/support/v4/media/MediaSession2$SessionCallback;->onPrepareFromUri(Landroid/support/v4/media/MediaSession2;Landroid/support/v4/media/MediaSession2$ControllerInfo;Landroid/net/Uri;Landroid/os/Bundle;)V
