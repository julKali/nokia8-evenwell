...
.method public splitText(I)Lorg/w3c/dom/Text;
    ...
    .line 214
    .local v5, "newText":Lorg/dom4j/CDATA;
    if-eqz v4, :cond_1

    .line 215
    invoke-interface {v4, v5}, Lorg/dom4j/Element;->add(Lorg/dom4j/CDATA;)V

    .line 218
    :cond_1
    invoke-static {v5}, Lorg/dom4j/dom/DOMNodeHelper;->asDOMText(Lorg/dom4j/CharacterData;)Lorg/w3c/dom/Text;
    ...
    .end local v5    # "newText":Lorg/dom4j/CDATA;
    :cond_2
    ...
    invoke-direct {v1, v3, v4}, Lorg/w3c/dom/DOMException;-><init>(SLjava/lang/String;)V
