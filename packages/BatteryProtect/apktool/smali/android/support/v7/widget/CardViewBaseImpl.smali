...
.method private getShadowBackground(Landroid/support/v7/widget/CardViewDelegate;)Landroid/support/v7/widget/RoundRectDrawableWithShadow;
    ...
    check-cast p0, Landroid/support/v7/widget/RoundRectDrawableWithShadow;
...
.method public getBackgroundColor(Landroid/support/v7/widget/CardViewDelegate;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->getColor()Landroid/content/res/ColorStateList;
...
.method public getElevation(Landroid/support/v7/widget/CardViewDelegate;)F
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->getShadowSize()F
...
.method public getMaxElevation(Landroid/support/v7/widget/CardViewDelegate;)F
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->getMaxShadowSize()F
...
.method public getMinHeight(Landroid/support/v7/widget/CardViewDelegate;)F
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->getMinHeight()F
...
.method public getMinWidth(Landroid/support/v7/widget/CardViewDelegate;)F
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->getMinWidth()F
...
.method public getRadius(Landroid/support/v7/widget/CardViewDelegate;)F
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->getCornerRadius()F
...
.method public setBackgroundColor(Landroid/support/v7/widget/CardViewDelegate;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->setColor(Landroid/content/res/ColorStateList;)V
...
.method public setElevation(Landroid/support/v7/widget/CardViewDelegate;F)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/RoundRectDrawableWithShadow;->setShadowSize(F)V
...
.method public updatePadding(Landroid/support/v7/widget/CardViewDelegate;)V
    ...
    invoke-interface {p1, v1, p0}, Landroid/support/v7/widget/CardViewDelegate;->setMinWidthHeightInternal(II)V
    ...
    invoke-interface {p1, p0, v1, v2, v0}, Landroid/support/v7/widget/CardViewDelegate;->setShadowPadding(IIII)V
